...
export class SeasonMatcher {
     ...
     */
    matchSeason(arg1 = {}, arg2 = {}, arg3 = {}, arg4 = {}, arg5 = {}) {
        let geographyAnalysis = arg1;
        let processingAnalysis = arg2;
        let teaTypeAnalysis = arg3;
        let flavorAnalysis = arg4;

        if (arg1 && typeof arg1 === 'object' && (arg1.geography || arg1.processing || arg1.caffeineLevel !== undefined)) {
            geographyAnalysis = arg2 || {};
            processingAnalysis = arg3 || {};
            teaTypeAnalysis = arg4 || {};
            flavorAnalysis = arg5 || {};
        }
        ...
        let normalizedScores = this.normalizeSeasonScores(seasonScores);
        const maxScoreValue = Math.max(...Object.values(normalizedScores), 0);
        if (maxScoreValue > 0 && maxScoreValue < 90) {
            const scaleFactor = 90 / maxScoreValue;
            normalizedScores = Object.fromEntries(
                Object.entries(normalizedScores).map(([season, score]) => [
                    season,
                    Math.min(100, Math.round(score * scaleFactor))
                ])
            );
        }
        trace.push({ 
